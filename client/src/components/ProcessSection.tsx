...
import { Coffee, Leaf, Sun, CheckCircle, TruckIcon } from "lucide-react";
  ...
  const steps = [
    {
      ...
      description:
        "Skilled farmers handpick only the ripest cherries at peak maturity from Ethiopia’s lush highlands—ensuring rich, complex flavors right from the start.",
    },
    {
      icon: <Coffee size={24} className="text-tadegg-cream" />,
      title: "Washed Processing",
      description:
        "We use the washed method to bring out bright, floral notes, carefully fermenting and washing beans to highlight their natural clarity and acidity.",
    },
    {
      icon: <Sun size={24} className="text-tadegg-cream" />,
      title: "Sun-Drying Perfection",
      description:
        "Our beans are gently sun-dried on raised beds, allowing air to circulate for even drying—preserving depth, body, and taste.",
    },
    {
      icon: <CheckCircle size={24} className="text-tadegg-cream" />,
      title: "Expert Sorting & Grading",
      description:
        "Every bean is hand-sorted to meet international specialty coffee standards. We ensure only the best beans proceed to export.",
    },
    {
      icon: <TruckIcon size={24} className="text-tadegg-cream" />,
      title: "Sustainable Storage & Export",
      description:
        "We store beans in eco-friendly jute bags and ship with care—delivering peak freshness to roasters and coffee lovers around the world.",
    },
  ];
    ...
    <section id="our-process" className="bg-gradient-to-b from-[#1A1F2C] to-[#2A2F3C] py-12 md:py-24 overflow-hidden relative">
      ...
      <div className="absolute top-0 right-0 w-72 h-72 opacity-5">
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          <path
            fill="white"
            d="M44.7,-76.4C58.9,-69.2,71.8,-59.1,79.6,-45.8C87.4,-32.6,90,-16.3,89.8,-0.1C89.6,16,86.7,32.1,78.7,44.9C70.7,57.7,57.7,67.3,43.5,74.4C29.3,81.5,14.7,86.1,0,86.1C-14.7,86.1,-29.3,81.4,-43.4,74.2C-57.4,67,-70.8,57.3,-78.3,44.3C-85.7,31.3,-87.2,15.7,-86.6,0.3C-86,-15,-83.4,-30,-76.6,-43.3C-69.8,-56.6,-58.9,-68.2,-45.4,-75.7C-31.9,-83.3,-15.9,-86.8,-0.2,-86.4C15.6,-86.1,31.2,-82,44.7,-76.4Z"
      ...
      <div className="container mx-auto px-4">
        <ScrollReveal>
          <div className="max-w-3xl mx-auto text-center mb-8 md:mb-16">
            ...
            <p className="text-base md:text-xl text-white/80">
              We carefully craft speciality coffee to share rich flavors with the world.
            </p>
          </div>
        </ScrollReveal>
        ...
        <div className="md:hidden space-y-8">
          {steps.map((step, idx) => (
            <ScrollReveal key={idx} direction="up" delay={idx * 150}>
              <div className="relative pl-10" onClick={() => setActiveStep(activeStep === idx ? null : idx)}>
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div className="bg-tadegg-burgundy/30 p-2 rounded-lg">{step.icon}</div>
                    <h3 className="text-xl font-serif font-semibold text-white">{step.title}</h3>
                  </div>
                  <div
                    className={cn(
                  ...
                  >
                    <p className="text-white/70 text-sm pb-2">{step.description}</p>
                  </div>
                  <div className="absolute right-4 top-4 text-white/50">
                    <svg
                      ...
                      fill="none"
                      stroke="currentColor"
                      className={cn("transition-transform duration-300", activeStep === idx ? "rotate-180" : "")}
                    >
        ...
        {/* Desktop View */}
        <div ref={stepsRef} className="hidden md:block max-w-5xl mx-auto relative">
            ...
            {steps.map((step, idx) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <h3 className="text-xl font-serif font-semibold text-white mb-3 text-center">{step.title}</h3>
