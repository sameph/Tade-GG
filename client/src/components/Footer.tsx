        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <div className="flex items-center gap-2 mb-6">
              <Coffee size={32} />
              <span className="text-2xl font-serif font-bold">Tadegg</span>
            </div>
            <p className="text-white/80 mb-6">
              Premium Ethiopian coffee exporters, connecting the world to the birthplace of arabica coffee through quality, sustainability, and direct trade relationships.
            </p>
            <div className="flex space-x-4">
              <a href="https://instagram.com" className="text-white/80 hover:text-white transition-colors">
                <Instagram size={20} />
              </a>
              <a href="https://facebook.com" className="text-white/80 hover:text-white transition-colors">
                <Facebook size={20} />
              </a>
              <a href="mailto:info@tadegg.com" className="text-white/80 hover:text-white transition-colors">
                <Mail size={20} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="#why-choose-us" className="text-white/80 hover:text-white transition-colors">Why Choose Us</a>
              </li>
              <li>
                <a href="#specialties" className="text-white/80 hover:text-white transition-colors">Our Specialties</a>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-xl font-serif font-semibold mb-6">Coffee Varieties</h3>
            <ul className="space-y-4">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/80">
                  Bole Road, Addis Ababa,<br/>Ethiopia, East Africa
                </span>
              </li>
