...
const specialties = [
  {
    ...
    description: "Welicho coffee grows in Ethiopia's highlands with deep green leaves and large purple-red cherries. Highly disease-resistant, it can produce up to three seeds per cherry in good conditions.",
  ...
  },
  {
    ...
    name: "Kumuree",
    localName: "Kurume",
    description: "An indigenous Ethiopian heirloom with exceptional adaptability. Known for its dense, small beans (typically two per cherry) and distinctive flavor profile.",
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-8 md:mb-16">
          ...
          <p className="text-tadegg-brown/80 text-sm md:text-base">
            Ethiopia's diverse geography produces distinct regional coffee varieties, each with unique characteristics.
          </p>
        </div>
        ...
        <div className="md:hidden mb-6">
          <div className="flex snap-x snap-mandatory overflow-x-auto gap-4 pb-4 scrollbar-hide">
            {specialties.map((specialty) => (
              <div 
                key={specialty.id}
                className="snap-start flex-shrink-0 w-[85vw] rounded-xl overflow-hidden shadow-lg bg-white"
              ...
              >
                <div className="relative h-48">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                    ...
                    <p className="text-white/80 text-sm">{specialty.localName}</p>
                  </div>
                </div>
                <div className="p-4">
                  <div className="flex flex-wrap gap-2 mb-3">
                    {specialty.tastes.slice(0, 2).map((taste) => (
                      <span key={taste} className="bg-tadegg-green/10 text-tadegg-green px-2 py-1 rounded-full text-xs">
                        {taste}
                      </span>
                    ))}
                  </div>
        ...
        <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-tadegg-brown/60 italic">{currentSpecialty.localName}</p>
            </div>
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="flex gap-4">
                <div className="flex-1 bg-tadegg-cream/30 p-3 rounded-lg">
                  <h4 className="text-xs text-tadegg-brown/60 mb-1">Altitude</h4>
                  <p className="font-medium text-tadegg-brown text-sm">{specialty.altitude}</p>
                </div>
                <div className="flex-1 bg-tadegg-cream/30 p-3 rounded-lg">
                  <h4 className="text-xs text-tadegg-brown/60 mb-1">Process</h4>
                  <p className="font-medium text-tadegg-brown text-sm">{specialty.process}</p>
                </div>
              </div>
          ...
          {[
            {
              icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M20 7L12 3L4 7M20 7V17L12 21M20 7L12 11M12 21L4 17V7M12 21V11M4 7L12 11" stroke="#3D550C" strokeWidth="2"/>
                </svg>
              ),
              title: "Bulk Export",
              description: "Flexible packaging from 60kg bags to full containers."
            },
            {
              icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M9 12L11 14L15 10M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="#3D550C" strokeWidth="2"/>
                </svg>
              ),
            ...
            },
            {
              icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M9 17H15M9 17C7.89543 17 7 16.1046 7 15V9C7 7.89543 7.89543 7 9 7H15C16.1046 7 17 7.89543 17 9V15C17 16.1046 16.1046 17 15 17M9 17L5 21M15 17L19 21M12 12H12.01M3 3L21 21" stroke="#3D550C" strokeWidth="2"/>
                </svg>
              ),
