...
const AdminLogin = () => {
  ...
  const handleLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      toast.success("Welcome to Tadegg Admin Dashboard", toastOptions);
      ...
      toast.error(error || "Invalid credentials", toastOptions);
    }
  };
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center p-8">
            ...
            <div className="bg-white/20 backdrop-blur-md p-6 rounded-xl border border-white/30">
              <p className="text-white text-xl mb-4">
                "The finest coffee begins with secured access."
              </p>
              <p className="text-tadegg-gold font-medium">
                ~ Tadegg Coffee Exporters
              </p>
            </div>
        ...
        <div className="w-full md:w-1/2 bg-white p-6 sm:p-12">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <p className="text-center text-sm text-gray-600 mt-8">
              Need help? Contact{" "}
              <a
                href="mailto:support@tadegg.com"
                className="text-[#3D550C] font-medium hover:underline"
              >
                support@tadegg.com
              </a>
            </p>
