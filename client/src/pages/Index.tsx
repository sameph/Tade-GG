...
const Index = () => {
  ...
  useEffect(() => {
    ...
    document.body.classList.add("page-loaded", "overflow-x-hidden");
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              transform: `translateY(${scrollY * -0.04}px) translateX(${scrollY * 0.02}px)`,
            }}
            data-aos="fade-in"
            data-aos-delay="600"
          ></div>
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <p
            ...
            data-aos-delay="300"
          >
            Experience the unparalleled quality and rich heritage of Ethiopian
            coffee through Tadegg's premium exports.
          </p>
        </div>
      </div>
